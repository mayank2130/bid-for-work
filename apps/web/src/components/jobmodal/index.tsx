  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 className="text-xl font-bold mb-4">Enter the Job details below</h2>
          <p className="mb-6">This form contains all the job details that are required to post a job</p>
